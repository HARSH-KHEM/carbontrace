    ...
    <div className="min-h-screen w-full grid place-items-center p-4 relative overflow-hidden bg-[#0a1f0f]">
      ...
      <div className="w-[100%] max-w-[400px] z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-on-surface-variant font-body-md">Start your sustainability journey today.</p>
        </div>

        <div className="w-full bg-white/5 backdrop-blur-[20px] border border-white/10 rounded-2xl p-8 shadow-2xl">
          <h2 className="font-headline-md text-2xl mb-6 text-white font-bold text-center">Create Account</h2>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            <div>
              <label className="block font-label-md text-on-surface-variant mb-2">Name</label>
              <input
                type="text"
                value={name}
          ...
          <p className="mt-6 text-center font-body-md text-on-surface-variant">
            ...
            <Link href="/login" className="text-primary hover:text-primary-fixed transition-colors font-medium">
              Sign In
            </Link>
          </p>
        </div>
